...
} from "./chunk-3JM3KYQ5.js";
import "./chunk-4R6N6V7S.js";
import {
  useCallbackRef
} from "./chunk-VY5TIVII.js";
import {
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime41.jsxs)(import_jsx_runtime40.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react14.cloneElement)(children, triggerProps), (0, import_jsx_runtime39.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var Pagination = React39.forwardRef(({
  ...
  return (0, import_jsx_runtime44.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames33.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames34.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React40.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime45.jsx)(Button_default, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
var Row = React44.forwardRef(({
  ...
  return (0, import_jsx_runtime49.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames37.default)(className, decoratedBsPrefix, ...classes)
  });
});
Row.displayName = "Row";
var Row_default = Row;
...
var Spinner = React45.forwardRef(({
  ...
  return (0, import_jsx_runtime50.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames38.default)(className, bsSpinnerPrefix, size && `${bsSpinnerPrefix}-${size}`, variant && `text-${variant}`)
  });
});
...
var SplitButton = React46.forwardRef(({
  ...
  flip,
  ...props
}, ref) => (0, import_jsx_runtime52.jsxs)(Dropdown_default, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime51.jsx)(Button_default, {
    size,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime51.jsx)(Dropdown_default.Toggle, {
    split: true,
    id,
    size,
    variant,
  ...
  }), (0, import_jsx_runtime51.jsx)(Dropdown_default.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    flip,
...
var Stack = React47.forwardRef(({
  ...
  return (0, import_jsx_runtime53.jsx)(Component2, {
    ...props,
    ref,
    className: (0, import_classnames39.default)(className, bsPrefix, ...createUtilityClassName({
      gap
...
function useTabPanel(_ref) {
  ...
  const context3 = (0, import_react16.useContext)(TabContext_default);
    ...
    return (0, import_jsx_runtime54.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime54.jsx)(SelectableContext_default.Provider, {
        ...
        children: (0, import_jsx_runtime54.jsx)(Transition, {
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime54.jsx)(Component2, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime56.jsx)(Tabs_default, {
  ...props,
...
var TabContent = React51.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var TabPane = React52.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
    ...
    children: (0, import_jsx_runtime58.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime58.jsx)(Transition, {
        ...
        children: (0, import_jsx_runtime58.jsx)(Component2, {
          ...rest,
          ref,
          className: (0, import_classnames41.default)(className, prefix, isActive && "active")
        })
      })
    })
  });
...
var Table = React53.forwardRef(({
  ...
  const classes = (0, import_classnames42.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size && `${decoratedBsPrefix}-${size}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
...
var ToastFade = React55.forwardRef((props, ref) => (0, import_jsx_runtime62.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React57.forwardRef(({
  ...
  const context3 = (0, import_react18.useContext)(ToastContext_default);
  ...
  return (0, import_jsx_runtime64.jsxs)("div", {
    ref,
    ...props,
    className: (0, import_classnames43.default)(bsPrefix, className),
...
var Toast = React59.forwardRef(({
  ...
  const toast = (0, import_jsx_runtime66.jsx)("div", {
    ...props,
    ref,
  ...
  return (0, import_jsx_runtime66.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime66.jsx)(Transition, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
...
var ToggleButton = React61.forwardRef(({
  ...
  return (0, import_jsx_runtime70.jsxs)(import_jsx_runtime69.Fragment, {
    children: [(0, import_jsx_runtime68.jsx)("input", {
      ...
      id
    }), (0, import_jsx_runtime68.jsx)(Button_default, {
      ...props,
      ref,
...
var ToggleButtonGroup = React62.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime71.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    vertical,
    children: map(children, (child) => {
